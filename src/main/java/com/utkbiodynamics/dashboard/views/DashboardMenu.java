...
import com.utkbiodynamics.dashboard.component.ProfilePreferencesWindow;
import com.utkbiodynamics.dashboard.database.RetrieveEcgs;
...
import com.utkbiodynamics.dashboard.event.DashboardEvent.PostViewChangeEvent;
import com.utkbiodynamics.dashboard.event.DashboardEvent.ProfileUpdatedEvent;
import com.utkbiodynamics.dashboard.event.DashboardEvent.ReportsCountUpdatedEvent;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("iCloud<strong>ECG</strong>",
                ContentMode.HTML);
